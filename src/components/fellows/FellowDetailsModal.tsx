...
const FellowDetailsModal = ({ fellow, isOpen, onClose }: FellowDetailsModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-2xl bg-zinc-800 text-white border-zinc-700">
        <DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col items-center py-4">
            <Avatar className="h-32 w-32 mb-4 border-2 border-pareto-pink">
          ...
          {/* Right column with bio and other details */}
