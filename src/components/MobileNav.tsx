      ...
      {isOpen && (
        <div className="fixed inset-0 top-16 bg-black/95 z-50 flex flex-col p-6">
          <div className="flex flex-col gap-8 items-center mt-12">
            ...
            <Link
              to="/apply"
              className="mt-6 whitespace-nowrap inline-flex items-center gap-2 px-5 py-2.5 text-white border border-white hover:bg-white/10 transition-colors text-[17px] font-figtree font-medium"
              onClick={toggleMenu}
            >
              APPLY NOW
            </Link>
