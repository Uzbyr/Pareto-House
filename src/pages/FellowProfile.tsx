...
import { Edit, Save, User, Globe, Briefcase, Loader2, Upload } from "lucide-react";
            ...
            <Card className="bg-zinc-800 border-zinc-700 p-6 flex flex-col items-center">
              ...
              {profile?.building_company && (
                <div className="mt-2 flex items-center">
                  ...
                  <span className="text-gray-300">{profile.building_company}</span>
                </div>
              )}
            ...
            <Card className="bg-zinc-800 border-zinc-700 p-6 lg:col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                <div>
                  ...
                  <p className="text-gray-200">{profile?.university || "Not specified"}</p>
                </div>
                
                <div>
                  <p className="text-gray-400 text-sm">Major</p>
                  <p className="text-gray-200">{profile?.major || "Not specified"}</p>
                </div>
                
                <div>
                  <p className="text-gray-400 text-sm">Graduation Year</p>
                  <p className="text-gray-200">{profile?.graduation_year || "Not specified"}</p>
                </div>
                
                {profile?.preparatory_classes && (
                  <div>
                    <p className="text-gray-400 text-sm">Preparatory Classes</p>
                    <p className="text-gray-200">{profile.preparatory_classes}</p>
                  </div>
                )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                <div>
                  ...
                  <p className="text-gray-200">{profile?.building_company || "Not specified"}</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                <div>
                  ...
                  <p className="text-gray-200">{profile?.country || "Not specified"}</p>
                </div>
                
                <div>
                  <p className="text-gray-400 text-sm">Nationality</p>
                  <p className="text-gray-200">{profile?.nationality || "Not specified"}</p>
                </div>
              </div>
            </Card>
          </div>
        ...
        <TabsContent value="edit">
          <Card className="bg-zinc-800 border-zinc-700 p-6">
            <div className="flex flex-col items-center mb-6">
              <Avatar className="w-32 h-32 mb-4">
                <AvatarImage
                  src={profilePicture ? URL.createObjectURL(profilePicture) : profile?.profile_picture_url || ""}
                  alt={`${profile?.first_name} ${profile?.last_name}`}
                />
                <AvatarFallback className="bg-zinc-700 text-2xl">
                  {getInitials()}
