  ...
  return <div className="min-h-screen bg-white dark:bg-pareto-black text-black dark:text-white font-inter">
      ...
      <div className="container mx-auto px-4 pt-36 md:pt-56 pb-20 flex flex-col justify-center min-h-[80vh]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-black/80 dark:text-white/80 mb-16 max-w-2xl mx-auto">Join a community of exceptional undergrads, access unparalleled opportunities, and accelerate your path to the top of the tech ecosystem.</p>
