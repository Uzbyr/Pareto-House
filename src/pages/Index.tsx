...
const Index = () => {
  return <div className="min-h-screen bg-pareto-black text-white font-inter">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
          ...
          <div className="flex gap-4 mb-12">
            ...
            delay: 0.7
          }} href="https://www.pareto20.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-pareto-pink text-black hover:bg-white transition-colors duration-300">
            ...
            delay: 0.7
              ...
              <Link to="/apply" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black hover:bg-pareto-pink transition-colors duration-300">
                Apply Now
              </Link>
            </motion.div>
          </div>
