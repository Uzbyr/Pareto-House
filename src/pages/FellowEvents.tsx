    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <Card className="bg-zinc-800 border-zinc-700 p-6">
        ...
        <div className="space-y-4 text-gray-300">
          <p>
            This calendar shows all upcoming events for Pareto Fellows,
            including:
          </p>
          ...
          <p>
            You can add this calendar to your personal Google Calendar by
            clicking the "+ Google Calendar" button at the bottom right of the
            calendar.
          </p>
        </div>
      </Card>
