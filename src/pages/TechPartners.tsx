    ...
    partners: [
      {
        ...
        description:
          "Provides access to AI computing resources, enabling businesses to integrate advanced AI capabilities into their operations.",
      ...
      },
      {
        ...
        description:
          "Focuses on developing reliable and steerable AI systems, advancing the field of artificial intelligence responsibly.",
      ...
      },
      {
        ...
        description:
          "Develops AI-driven solutions to enhance marketing strategies and optimize advertising campaigns.",
      ...
      },
      {
        ...
        description:
          "Provides data annotation and labeling services to accelerate the development of artificial intelligence applications across various industries.",
      ...
      },
      {
        ...
        description:
          "Develops AI tools to enhance corporate workflows and data analysis, improving decision-making processes.",
      ...
      },
      {
        ...
        description:
          "Provides AI solutions to improve corporate data retrieval and management, facilitating knowledge sharing within organizations.",
    ...
    partners: [
      {
        ...
        description:
          "Focuses on AI technologies to optimize business operations, enhancing efficiency and productivity.",
      ...
      },
      {
        ...
        description:
          "Specializes in AI coding tools to assist developers in writing and debugging code, accelerating software development.",
      ...
      },
      {
        ...
        description:
          "Utilizes AI to enhance customer relationship management and sales processes, boosting client engagement.",
      ...
      },
      {
        ...
        description:
          "Offers AI-driven hiring software to streamline recruitment processes and identify top talent efficiently.",
      ...
      },
      {
        ...
        description:
          "Offers AI-driven solutions to address talent shortages and streamline hiring, connecting companies with qualified candidates.",
      ...
      },
      {
        ...
        description:
          "Innovates in the housing market with AI-driven property management solutions, enhancing tenant experiences.",
    ...
    partners: [
      {
        ...
        description:
          "Develops AI tools to automate medical coding and billing processes, reducing administrative burdens in healthcare.",
      ...
      },
      {
        ...
        description:
          "Provides AI-driven solutions to streamline healthcare administration and improve patient care coordination.",
      ...
      },
      {
        ...
        description:
          "Offers comprehensive pediatric care powered by AI diagnostics, improving early detection and treatment.",
      ...
      },
      {
        ...
        description:
          "Provides AI-powered solutions for women's health and wellness, offering personalized insights and guidance.",
      ...
      },
      {
        ...
        description:
          "Enhances mental health support through AI-driven platforms connecting patients and therapists.",
    ...
    partners: [
      {
        ...
        description:
          "Provides cloud security solutions powered by AI, helping organizations protect their cloud infrastructure.",
      ...
      },
      {
        ...
        description:
          "Focuses on legal technology solutions powered by artificial intelligence, streamlining legal research and documentation.",
      ...
      },
      {
        ...
        description:
          "Detects deepfakes and enhances security using AI, safeguarding against digital misinformation.",
      ...
      },
      {
        ...
        description:
          "Enhances security systems using advanced AI technologies, protecting organizations from emerging threats.",
      ...
      },
      {
        ...
        description:
          "Transforms contract management with artificial intelligence, automating legal document analysis.",
    ...
    partners: [
      {
        ...
        description:
          "Develops advanced mobile robots, known for their agility and mobility, to automate tasks in various industries.",
      ...
      },
      {
        ...
        description:
          "Designs and builds legged robots to operate in human environments, addressing labor shortages and enhancing productivity.",
      ...
      },
      {
        ...
        description:
          "Develops humanoid robots powered by artificial intelligence to perform tasks in dynamic environments, aiming to revolutionize the workforce.",
      ...
      },
      {
        ...
        description:
          "Focuses on creating versatile robotic systems designed to work alongside humans in various industries, enhancing efficiency and safety.",
    ...
    partners: [
      {
        ...
        description:
          "Aims to build the world's first commercially viable quantum computer using silicon photonics technology.",
      ...
      },
      {
        ...
        description:
          "Develops scalable quantum computers using neutral-atom technology to solve complex computational problems.",
      ...
      },
      {
        ...
        description:
          "Pursues the development of fusion energy technology to provide a safe, clean, and virtually limitless energy source.",
      ...
      },
      {
        ...
        description:
          "Focuses on advancing fusion energy solutions to meet the growing global demand for clean and sustainable power.",
      ...
      },
      {
        ...
        description:
          "Aims to commercialize fusion energy by developing compact fusion power plants using high-temperature superconductors.",
        linkedin:
          "https://www.linkedin.com/company/commonwealth-fusion-systems/",
    ...
    partners: [
      {
        ...
        description:
          "Democratizes data analytics with AI-driven platforms accessible to various industries, enabling data-driven decisions.",
      ...
      },
      {
        ...
        description:
          "Advances e-commerce logistics using artificial intelligence for efficiency, optimizing supply chain operations.",
      ...
      },
      {
        ...
        description:
          "Simplifies compliance processes with AI-driven solutions, ensuring organizations meet regulatory requirements.",
      ...
      },
      {
        ...
        description:
          "Boosts email security through AI-driven solutions, protecting organizations from phishing attacks.",
      ...
      },
      {
        ...
        description:
          "Pioneers AI video creation for business applications, enabling easy production of engaging content.",
      ...
      },
      {
        ...
        description:
          "Enhances cybersecurity with autonomous security operations, automating threat detection and response.",
    ...
    partners: [
      {
        ...
        description:
          "Specializes in defense technology, developing advanced surveillance and reconnaissance systems to enhance national security.",
      ...
      },
      {
        ...
        description:
          "Provides advanced AI-driven cybersecurity solutions, protecting organizations from sophisticated cyber threats.",
      ...
      },
      {
        ...
        description:
          "Develops artificial intelligence systems for defense applications, focusing on autonomous aircraft to protect service members and civilians.",
      ...
      },
      {
        ...
        description:
          "Develops intelligent robotic systems that adapt to complex environments, enhancing automation capabilities across industries.",
      ...
      },
      {
        ...
        description:
          "Specializes in creating autonomous robotic solutions to optimize manufacturing processes and improve operational efficiency.",
    ...
    partners: [
      {
        ...
        description:
          "Uses AI to provide automated bookkeeping software for small businesses, simplifying financial management.",
      ...
      },
      {
        ...
        description:
          "An online grocery platform that offers affordable access to high-quality, sustainably sourced food by rescuing and distributing surplus and imperfect produce.",
      ...
      },
      {
        ...
        description:
          "Streamlines financial processes through AI-powered solutions, enhancing efficiency and accuracy in financial management.",
      ...
      },
      {
        ...
        description:
          "Develops AI support agents to assist businesses in customer service, providing efficient and accurate responses.",
...
const TechPartners = () => {
  ...
  useEffect(() => {
    ...
    const techPartnersPageViews =
      localStorage.getItem("techPartnersPageViews") || "0";
    localStorage.setItem(
      "techPartnersPageViews",
      (parseInt(techPartnersPageViews) + 1).toString(),
    );
  }, []);
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <div className="text-center mt-10 mb-12">
              ...
              <p
                className="mt-4 text-black/60 dark:text-white/60 max-w-xl mx-auto animate-fade-in"
                style={{ animationDelay: "0.1s" }}
              >
                Pareto Fellows gain exclusive access to resources, mentorship,
                and opportunities from our tech partners.
              </p>
            </div>
          </div>
          ...
          {selectedPartner && (
            <div
              className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 overflow-y-auto animate-fade-in"
              onClick={() => setSelectedPartner(null)}
            >
              <Card
                className="max-w-2xl w-full bg-white dark:bg-zinc-900 p-0 m-4 animate-scale-in"
                    ...
                    <div className="flex items-center gap-4">
                      <div className="h-20 w-20 bg-zinc-100 dark:bg-zinc-800 rounded-md flex items-center justify-center overflow-hidden">
                        {selectedPartner.logo ? (
                          ...
                          <span className="text-2xl font-semibold text-pareto-pink">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                {category.partners.map((partner, partnerIndex) => (
                  <button
                    ...
                    style={{
                      animationDelay: `${categoryIndex * 0.1 + partnerIndex * 0.05}s`,
                    }}
                      ...
                      <div className="text-center">
                        {partner.logo ? (
                          ...
                          <div className="w-16 h-16 bg-zinc-100 dark:bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                            <span className="text-xl font-semibold text-pareto-pink">
          ...
          >
            ...
            <p className="text-black/60 dark:text-white/60 max-w-xl mx-auto mb-8">
              We're always looking to expand our network of partners to provide
              even more opportunities for our fellows.
            </p>
            <a
